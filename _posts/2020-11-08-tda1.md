...
To do this, the idea is to place a [closed ball](https://mathworld.wolfram.com/ClosedBall.html) of radius $$\epsilon$$ around each point, and create an edge between any two points if their closed $$\epsilon$$ balls intersect. 
